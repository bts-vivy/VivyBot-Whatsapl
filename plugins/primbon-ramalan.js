...
if (!Number(text)) return m.reply(`Contoh : ${usedPrefix + command} 6283143770528`)
...
if (!text) return m.reply(`Contoh : ${usedPrefix + command}Siti, 24, 4, 2004, amat, 19, 3, 2001`)
let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
if (anu.status == false) return m.reply(anu.message)
m.reply(`• *Nama Anda :* ${anu.message.nama_anda.nama}\n• *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n• *Nama send :* ${anu.message.nama_pasangan.nama}\n• *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n• *Hasil :* ${anu.message.result}\n• *Catatan :* ${anu.message.catatan}`)
}
break
...
break
case 'artinama': {
if (!text) return m.reply(`Contoh : ${usedPrefix + command}Siti`)
...
if (!text) return m.reply(`Contoh : ${usedPrefix + command}Siti, 24, 4, 2004`)
...
if (!text) return m.reply(`Contoh : ${usedPrefix + command} 20, 12, 2023`)
...
break
case 'sifatusaha': {
if (!ext)return m.reply(`Contoh : ${usedPrefix+ command} 20, 12, 2023`)
let [tgl, bln, thn] = text.split`,`
...
if (!text) return m.reply(`Contoh : ${usedPrefix + command} 24, 4, 2004`)
let [tgl, bln, thn] = text.split`,`
...
if (!text) return m.reply(`Contoh : ${usedPrefix + command} 4, 24, 2004`)
let [tgl, bln, thn] = text.split`,`
...
if (!text) return m.reply(`Contoh : 24, 4, 2004`)
let [tgl, bln, thn] = text.split`,`
...
break
case 'memancing': {
if (!text) return m.reply(`Contoh : ${usedPrefix + command} 24, 4, 2023`)
let [tgl, bln, thn] = text.split`,`
...
break
case 'masasubur': {
if (!text) return m.reply(`Contoh : ${usedPrefix + command} 24, 4, 2023, 28\n\nNote : ${usedPrefix + command} Hari Pertama Menstruasi, Siklus`)
